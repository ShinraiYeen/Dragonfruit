...
WavParser::WavParser(DataSource& data_source) {
    // Load RIFF metadata
    RiffChunk chunk;
...
void WavParser::HandleFmtChunk(DataSource& file, size_t size) {
...
void WavParser::HandleListChunk(DataSource& file, size_t size) {
    InfoChunk chunk;
...
void WavParser::HandleUnknownChunk(DataSource& file, size_t size) { file.Seek(file.Tell() + size); }

void WavParser::ParseChunk(ChunkHeader header, DataSource& file) {
...
bool WavParser::ReadChunk(DataSource& file) {
